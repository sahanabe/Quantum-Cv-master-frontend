...
const Support = () => (
  <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #101522 60%, #246bfd 100%)', padding: '60px 0', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
    <div style={{
      ...
      <h1 style={{ fontSize: 36, fontWeight: 900, color: '#246bfd', marginBottom: 16, textShadow: '0 2px 12px #246bfd88' }}>Support</h1>
      ...
      <div style={{ color: '#b0b3c7', fontSize: 18, textAlign: 'left', maxWidth: 600, margin: '0 auto', lineHeight: 1.7 }}>
        <p>Email us at <a href="mailto:support@quantumcv.com" style={{ color: '#246bfd' }}>support@quantumcv.com</a> or use our contact form.</p>
      </div>
    </div>
  </div>
);
